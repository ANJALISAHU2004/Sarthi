...
function Cards() {
  return (
    <div className="Top-colleges">
      <div className="bg">{/* <h1>Kiberbash</h1> */}</div>
      <div className="nft">
        <div className="main">
          <img
      ...
      <div className="nft">
        <div className="main">
          ...
          <div className="creator">
            <div className="wrapper">
              <img
                src="https://www.bing.com/ck/a?!&&p=38eeb06699b88523JmltdHM9MTcyNTc1MzYwMCZpZ3VpZD0wNWVlZWIzMC05OTNmLTYzODItMjFlZi1mODZiOTg4ZDYyOTAmaW5zaWQ9NTY0NQ&ptn=3&ver=2&hsh=3&fclid=05eeeb30-993f-6382-21ef-f86b988d6290&u=a1L2ltYWdlcy9zZWFyY2g_cT1paXQlMjBwaWNzJkZPUk09SVFGUkJBJmlkPTkxRDFGNzBDOTg4QzAyMjM3RDQwQTE0OEI3RTg0MzdDRDkwMzZBNzM&ntb=1"
                alt="Creator"
              />
            </div>
            <p>
